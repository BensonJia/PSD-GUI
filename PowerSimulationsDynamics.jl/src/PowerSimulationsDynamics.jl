...
export CompiledNetwork
export compile_network
export load_compiled_network
export save_compiled_network
export export_network
export network_fingerprint
...
include("base/compiled_network.jl")
